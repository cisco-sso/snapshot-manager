...
func NewForConfig(c *rest.Config) (*SnapshotmanagerV1alpha1Client, error) {
	...
	return &SnapshotmanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new SnapshotmanagerV1alpha1Client for the given config and
...
func New(c rest.Interface) *SnapshotmanagerV1alpha1Client {
	return &SnapshotmanagerV1alpha1Client{c}
}
...
func (c *SnapshotmanagerV1alpha1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
